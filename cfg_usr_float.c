/* configuration handler with two user defined (exotic) floating point numbers
...
/*
int trace_config_usr_float(struct trace_context *tr, union trace_config_prefix prefix)
{
	return 0;
}
*/
